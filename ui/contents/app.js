...
throw new Error("Module parse failed: C:\\Sandbox\\ethPaymentGateway\\ui\\src\\EthService.js Unexpected token (26:10)\nYou may need an appropriate loader to handle this file type.\n|     }    \r\n| \r\n|     async getContractAbiAsJson(){\r\n|         let response = await fetch(this.contractAbiUrl);\r\n|         let data = await response.json();\r");
...
module.exports = !__webpack_require__(46) && !__webpack_require__(115)(function () {
...
var descriptor = __webpack_require__(120);
var setToStringTag = __webpack_require__(82);
var IteratorPrototype = {};

// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(47)(IteratorPrototype, __webpack_require__(19)('iterator'), function () { return this; });
...
$export($export.S + $export.F * !__webpack_require__(46), 'Object', { defineProperty: __webpack_require__(55).f });
...
var forOf = __webpack_require__(175);
...
exports.EthPaymentGateway = undefined;
...
var _createClass2 = __webpack_require__(163);

var _createClass3 = _interopRequireDefault(_createClass2);

var _EthService = __webpack_require__(167);

var _EthService2 = _interopRequireDefault(_EthService);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var EthPaymentGateway = exports.EthPaymentGateway = function () {
   function EthPaymentGateway() {
      (0, _classCallCheck3.default)(this, EthPaymentGateway);

      this.web3Instance = new Web3(new Web3.providers.HttpProvider("http://localhost:7545"));
      this.contractAddress = "0xEDC6366E1db97a8104AE15a6438c3d52AB3112e8";
      this.priceDiscoveryUrl = "https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=GBP";
      this.ethService = new _EthService2.default();
   }

   (0, _createClass3.default)(EthPaymentGateway, [{
      key: "getCostInWeiFromCostInGbp",
      value: function () {
         var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(amountInGbp) {
         ...
         function getCostInWeiFromCostInGbp(_x) {
      ...
      key: "sendTx",
      value: function () {
         var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(eth, txRef) {
            var contract;
      ...
      key: "addMerchant",
      value: function () {
         var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(address, name) {
            var contract;
      ...
      value: function () {
         var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
            var eth, abi, contract;
            return _regenerator2.default.wrap(function _callee4$(_context4) {
               while (1) {
                  switch (_context4.prev = _context4.next) {
                     case 0:
                        eth = this.web3Instance.eth;
                        _context4.next = 3;
                        return this.ethService.getContractAbiAsJson();

                     case 3:
                        this.contractAbi = _context4.sent;
                        abi = eth.contract(this.contractAbi);
                        contract = abi.at(this.contractAddress);
...
var dP = __webpack_require__(55);
var createDesc = __webpack_require__(120);
...
var toPrimitive = __webpack_require__(196);
